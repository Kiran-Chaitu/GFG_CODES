<h2><a href="https://www.geeksforgeeks.org/problems/count-the-substrings--141634/1?page=3&category=Arrays,Strings,Tree,Sorting,Hash,Bit%20Magic,Linked%20List,Stack,Recursion,Searching,Binary%20Search%20Tree,Binary%20Search,DFS,BFS,two-pointer-algorithm,Queue,Backtracking,Map,sliding-window,prefix-sum&difficulty=Basic,Easy&status=unsolved&sortBy=accuracy">Count the Substrings</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string&nbsp;<strong>S</strong>. The task is to count the number of substrings which contains equal number of lowercase and uppercase letters.&nbsp;</span></p>
